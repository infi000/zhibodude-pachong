...
// var website = "http://www.zhibodude.com/";
var url = require("url");
    ...
    if (req.params.id == "1") {
        superagent.get(website)
            ...
            .set({
                ...
                'If-None-Match': 'W/"585e82e3-bec"',
                "Referer": "http://nba.tmiaoo.com/body.html"
            })
        ...
        fs.readFile('./public/data/jrs.json', 'utf-8', function(err, data) {
            if (err) {
                console.log(err);
            } else {
               res.send(data);
